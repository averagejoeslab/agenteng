...
- **Loop bounds.** A `MAX_ITERATIONS` cap on the inner TAO loop. Why `for/else` is the cleanest Python shape for this, and what to feed back to the model when the cap trips.
