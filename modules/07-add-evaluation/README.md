...
- **Trajectory analysis.** Looking past final-answer correctness to *how* the agent got there — extra tool calls, dead ends, wasted tokens.
...
**Next:** [Module 8: Add guardrails](../08-add-guardrails/)
